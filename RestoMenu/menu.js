...
i18n.menu.items = {
  ...
  "hot-main": {
    ...
    "Филе «Миньон» с овощами «Тиано»": {
      "ru": "Филе «Миньон» с морковным пюре",
  ...
  "breakfast": {
    ...
    "Шакшука с сосисками": {
      "ru": "Шакшука с сосисками",
      "kk": "Шұжық қосылған шакшука",
      "en": "Shakshuka with sausages"
    },
    "Рисовая каша": {
      "ru": "Рисовая каша",
      "kk": "Күріш ботқасы",
    ...
    "Американский завтрак": {
      "ru": "Американский завтрак",
      "kk": "Американдық таңғы ас",
    ...
    "Скрэмбл с лососем": {
      "ru": "Скрэмбл с лососем",
      "kk": "Лосось қосылған скрэмбл",
      "en": "Scrambled eggs with salmon"
    },
    "Яичница с сосиской": {
      "ru": "Яичница с сосиской",
      "kk": "Шұжық қосылған куйрылған жұмыртқа",
      "en": "Fried eggs with sausage"
    },
    "Брускетта с гуакамоле,лососем и яйцом пашот": {
      "ru": "Брускетта с гуакамоле, лососем и яйцом пашот",
      "kk": "Гуакамоле, лосось және пашот жұмыртқасы қосылған брускетта",
      "en": "Bruschetta with guacamole, salmon and poached egg"
    },
  ...
  "desserts": {
    ...
    "Чизкейк шоколадный": {
      "ru": "Чизкейк шоколадный",
      "kk": "Шоколадты чизкейк",
...
i18n.menu.descs = {
  ...
  "breakfast": {
    ...
    "Нежное куриное филе, свежие огурцы и помидоры, сладкая кукуруза и яйцо пашот": {
      "ru": "Нежное куриное филе, свежие огурцы и помидоры, сладкая кукуруза и яйцо пашот",
      "kk": "Нәзік тауық филесі, жаңа қияр мен қызанақ, тәтті жүгері және пашот жұмыртқа",
      "en": "Tender chicken fillet, fresh cucumbers and tomatoes, sweet corn and poached egg"
    },
    "Классическая яичница, ароматные охотничьи колбаски, сочные помидоры черри, красная фасоль, обжаренные шампиньоны и свежий микс салата.": {
      "ru": "Классическая яичница, ароматные охотничьи колбаски, сочные помидоры черри, красная фасоль, обжаренные шампиньоны и свежий микс салата",
      "kk": "Классикалық куйрылған жұмыртқа, хош иісті аңшы шұжықтары, шырынды черри қызанақ, қызыл бұршақ, қуырылған шампиньондар және жаңа салат миксі",
      "en": "Classic fried eggs, aromatic hunter sausages, juicy cherry tomatoes, red beans, sautéed mushrooms and fresh salad mix"
    },
    "Нежное куриное филе, брокколи на пару, сладкая кукуруза, отварная гречка и яйцо пашот": {
      "ru": "Нежное куриное филе, брокколи на пару, сладкая кукуруза, отварная гречка и яйцо пашот",
      "kk": "Нәзік тауық филесі, бумен пісірілген брокколи, тәтті жүгері, қайнатылған гречка және пашот жұмыртқа",
      "en": "Tender chicken fillet, steamed broccoli, sweet corn, boiled buckwheat and poached egg"
    },
    "Тост с нежным сливочным сыром и лососем, микс свежих листьев салата, ломтик сыра, варёное яйцо и сочные помидоры.": {
      "ru": "Тост с нежным сливочным сыром и лососем, микс свежих листьев салата, ломтик сыра, варёное яйцо и сочные помидоры",
      "kk": "Нәзік кілегей ірімшігі мен лосось қосылған тост, жаңа салат жапырақтарының миксі, ірімшік тілімі, қайнатылған жұмыртқа және шырынды қызанақ",
      "en": "Toast with cream cheese and salmon, fresh lettuce mix, cheese slice, boiled egg and juicy tomatoes"
    }
  },
  ...
  "bread": {
    "Белый,бородинский,чесночный": {
      "ru": "Белый,бородинский,чесночный",
      "kk": "Ақ, бородин наны, сарымсақты",
      "en": "White, Borodinsky, garlic"
    },
...
function renderBarProducts() {
  ...
  list.innerHTML = `<button class='cat-chip' id='backBarCats' type='button' role='button' tabindex='0'>${getCategoryName(cat.id, cat.name)}</button>` +
    cat.items.filter(filterSearch(q, cat.id)).map(item => {
      const key = keyOf(cat.id, item.n);
      const qty = state.cart[key]?.qty || 0;
      return `
        <div class="product" data-key="${key}">
          <div><div class="p-name">${translateItemName(cat.id, item.n)}</div></div>
          <div class="p-actions">
            <div class="price">${fmt(item.p)}</div>
            <div class="p-controls">
              ${qty ? qtyControl(qty) : `<button class="btn btn-primary add">+</button>`}
